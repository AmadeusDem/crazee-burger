...
export default function Button({ className, disabled, label, Icon, onClick, version = "primary" }) {
  return (
    <ButtonStyled className={className} disabled={disabled} onClick={onClick} version={version}>
      <span>{label}</span>
